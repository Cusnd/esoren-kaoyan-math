...
\begin{knowledgeBox}
\knowledgeIndexAnchor[substitution-as-whole]{整体换元}
\textbf{整体换元反求函数表达式}
...
\knowledgeIndexAnchor[inverse-function]{反函数}
\textbf{求反函数五步法}
...
\knowledgeIndexAnchor[composite-function]{复合函数}
\textbf{整体视角反求中间函数}
...
\knowledgeIndexAnchor[implicit-function]{隐函数}
\textbf{隐函数特殊点观察法}
...
\begin{itemize}
  ...
  \item \textbf{关联知识点：} \knowledgeRef[implicit-function]{隐函数}（第 1 讲“隐函数的概念与观察法”）。
\end{itemize}

\knowledgeIndexAnchor[boundedness]{有界性}
\textbf{有界性放缩找上界}
...
\knowledgeIndexAnchor[monotonicity]{单调性}
\textbf{单调性定义法追踪不等号}
...
\knowledgeIndexAnchor[odd-function]{奇函数}
\textbf{函数方程赋值法}
...
\knowledgeIndexAnchor[periodic-function]{周期函数}
\textbf{递推式证明周期性}
...
\knowledgeIndexAnchor[reciprocal-substitution]{倒数代换}
\textbf{对偶代换建立方程组}
