...
\setlist{leftmargin=2.2em, itemsep=0.18em, topsep=0.35em, parsep=0pt}
\setlist[enumerate]{label=\arabic*., itemsep=0.18em}
...
\titleformat{\subsection}
  ...
  {0.75em}
  {}
\titlespacing*{\section}{0pt}{2.4ex plus 0.8ex minus 0.2ex}{1.6ex}
\titlespacing*{\subsection}{0pt}{2.0ex plus 0.6ex minus 0.2ex}{0.9ex}
...
\NewDocumentEnvironment{problemMeta}{}{%
  ...
  \par\endgroup\addvspace{0.45\baselineskip}%
