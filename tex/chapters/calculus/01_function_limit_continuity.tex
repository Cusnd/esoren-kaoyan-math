...
\knowledgeAnchor[inverse-function]{反函数}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[inverse-function]{反函数}}\par
...
\textbf{知识点：} \knowledgeRef[inverse-function]{反函数}，对数性质，有理化，双曲函数
\end{problemMeta}
...
\knowledgeAnchor[composite-function]{复合函数}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[composite-function]{复合函数}}\par
...
\textbf{知识点：} \knowledgeRef[composite-function]{复合函数}，整体视角，定义域，值域，平方根分支
\end{problemMeta}
...
\textbf{知识点：} \knowledgeRef[composite-function]{复合函数}，分段函数，内层函数取值范围，数形结合
\end{problemMeta}
...
\knowledgeAnchor[implicit-function]{隐函数}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[implicit-function]{隐函数}}\par
...
\subsection{函数的有界性}
\knowledgeAnchor[boundedness]{有界性}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[boundedness]{有界性}}\par
...
\textbf{知识点：} \knowledgeRef[boundedness]{有界性}，绝对值，基本不等式，放缩
\end{problemMeta}
...
\textbf{知识点：} \knowledgeRef[boundedness]{有界性}，基本不等式，分母放缩，有理化
\end{problemMeta}
...
\subsection{函数的单调性}
\knowledgeAnchor[monotonicity]{单调性}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[monotonicity]{单调性}}\par
...
\textbf{知识点：} \knowledgeRef[monotonicity]{单调性}定义，图像对称，复合与变号
\end{problemMeta}
...
\subsection{函数的奇偶性}
\knowledgeAnchor[odd-function]{奇函数}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[odd-function]{奇函数}}\par
...
\textbf{知识点：} \knowledgeRef[odd-function]{奇函数}，函数方程，赋值法
\end{problemMeta}
...
\subsection{函数的周期性}
\knowledgeAnchor[periodic-function]{周期函数}
\noindent{\footnotesize\textbf{索引：} \knowledgeIndexRef[periodic-function]{周期函数}}\par
...
\textbf{知识点：} \knowledgeRef[periodic-function]{周期函数}，递推式，三角函数诱导公式
\end{problemMeta}
...
\textbf{知识点：} \knowledgeIndexRef[substitution-as-whole]{整体换元}，函数表示，\(u+\frac{1}{u}\) 的值域
\end{problemMeta}
...
\textbf{知识点：} 定义域，\knowledgeIndexRef[reciprocal-substitution]{倒数代换}，二元一次方程组，根式化简
\end{problemMeta}
